...
public class EmployeesUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            if(e.getEmployeeCode().equals(request.getParameter("employeeCode"))) {
                code_duplicate_check = false;
            } else {
                e.setEmployeeCode(request.getParameter("employeeCode"));
            }
            ...
            e.setSectionCode(request.getParameter("sectionCode"));

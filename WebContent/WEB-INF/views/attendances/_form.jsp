...
<input type="time" name="break_start_time" value="<fmt:formatDate value='${attendance.break_start_time}' pattern='HH:mm' />"/>
<br /><br />

<label for="break_finish_time">休憩終了時刻</label><br />
<input type="time" name="break_finish_time" value="<fmt:formatDate value='${attendance.break_finish_time}' pattern='HH:mm' />"/>
<br /><br />

...
<input type="date" name="work_date" value="<fmt:formatDate value='${breaks.work_date}' pattern='yyyy-MM-dd' />" />
<br /><br />
...
<input type="time" name="break_finish_time" value="<fmt:formatDate value='${breaks.break_finish_time}' pattern='HH:mm' />"/>
<br /><br />
